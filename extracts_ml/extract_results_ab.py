...
def menu():
	    ...
	    if(directory != ".DS_Store"):	
                ...
                linha2 = "/home/maria/dsverifier/./dsverifier /home/maria/test-case-1/esbcm/newStability/8-bits/DFI/bits-1-7/Uncertainty-0.0/test-case-1/"+directory+" --property STABILITY_CLOSED_LOOP --bmc ESBMC --realization DFI --connection-mode FEEDBACK --x-size 10 --timeout 518400 > /home/maria/resultados/newresultados_stability/case-1_SCL_8Bits-bits-1-7-U00_ESBMC_"+directory+"_resultado_21_08.txt"
                linha3 = ""
